// Variables
const publicSpreadsheetUrl = "https://docs.google.com/spreadsheets/d/e/2PACX-1vSdFRuJfA88dCYlH3wmM4QiKAW5gaWDpFQG_x4cwen9j4QzSscebNccC6eYQp2wersIY1VzdxoXS8Vo/pub?output=csv";
const categoryStartNum = 4;
const sheetName = "diyScreenPrinting";
    ...
    for (let i = categoryStartNum; i < columnArray.length; i++) {
        for (let j = 0; j < data.length; j++) {
            ...
            if (columnData == checked) {
                addElement(columnName[i], data[j][columnName[0]], data[j][columnName[1]], data[j][columnName[2]], data[j][columnName[3]]);
            }
        }
    }
